...
public class SubmitFailure {
  ...
  public static SubmitFailure fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new com.daml.hunter.model.daml.script.SubmitFailure(status, description);
  }
  ...
  public String toString() {
    return String.format("com.daml.hunter.model.daml.script.SubmitFailure(%s, %s)", this.status, this.description);
  }
}

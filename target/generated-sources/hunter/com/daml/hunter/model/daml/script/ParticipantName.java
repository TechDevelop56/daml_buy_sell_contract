...
public class ParticipantName {
  ...
  public static ParticipantName fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new com.daml.hunter.model.daml.script.ParticipantName(participantName);
  }
  ...
  public String toString() {
    return String.format("com.daml.hunter.model.daml.script.ParticipantName(%s)", this.participantName);
  }
}

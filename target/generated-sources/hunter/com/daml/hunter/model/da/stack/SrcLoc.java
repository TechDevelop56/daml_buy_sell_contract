package com.daml.hunter.model.da.stack;
...
public class SrcLoc {
  ...
  public static SrcLoc fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new com.daml.hunter.model.da.stack.SrcLoc(srcLocPackage, srcLocModule, srcLocFile, srcLocStartLine, srcLocStartCol, srcLocEndLine, srcLocEndCol);
  }
  ...
  public String toString() {
    return String.format("com.daml.hunter.model.da.stack.SrcLoc(%s, %s, %s, %s, %s, %s, %s)", this.srcLocPackage, this.srcLocModule, this.srcLocFile, this.srcLocStartLine, this.srcLocStartCol, this.srcLocEndLine, this.srcLocEndCol);
  }
}

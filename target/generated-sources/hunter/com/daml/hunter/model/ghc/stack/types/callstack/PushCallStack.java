...
import com.daml.hunter.model.da.types.Tuple3;
import com.daml.hunter.model.ghc.stack.types.CallStack;
import com.daml.hunter.model.ghc.stack.types.SrcLoc;
...
public class PushCallStack extends CallStack {
  ...
  public static PushCallStack fromValue(Value value$) throws IllegalArgumentException {
    ...
    Tuple3<String, SrcLoc, CallStack> body = Tuple3.<java.lang.String, com.daml.hunter.model.ghc.stack.types.SrcLoc, com.daml.hunter.model.ghc.stack.types.CallStack>fromValue(variantValue$, v$0 -> v$0.asText().orElseThrow(() -> new IllegalArgumentException("Expected body to be of type com.daml.ledger.javaapi.data.Text")).getValue(), v$1 -> SrcLoc.fromValue(v$1), v$2 -> CallStack.fromValue(v$2));
